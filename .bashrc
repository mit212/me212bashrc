...
# above line must stay at first line
export ENV=$ENV
...
case $ENV in
    "lab2") 
       if [ -f ~/me212lab2/catkin_ws/devel/setup.bash ]; then
         source ~/me212lab2/catkin_ws/devel/setup.bash
       fi
       ;;
    "lab2_sol") source /home/robot/software/me212lab/lab2_sol/catkin_ws/devel/setup.bash;;
    "lab3") 
       if [ -f ~/me212lab3/software/config/environment.sh ]; then
         source ~/me212lab3/software/config/environment.sh
       fi
       ;;
